...
class Kiwoom(QMainWindow, form_class):
    ...
    def init_ENV(self) :
        ...
        self.workers = [None, None,None,None,None,None,None,None,None,None]
    ...
    def create_thread(self) :
        ...
        # ## 1st        
        # self.th_seq = 0
        # self.worker0 = module_worker.Worker(self.th_seq)
        ...
        # ## 2nd
        # self.th_seq = 1
        # self.worker1 = module_worker.Worker(self.th_seq)
        ...
        # ## 2nd
        # self.th_seq = 2
        # self.worker2 = module_worker.Worker(self.th_seq)
        ...
        # ## 2nd
        # self.th_seq = 3
        # self.worker3 = module_worker.Worker(self.th_seq)
        ...
        # ## 2nd
        # self.th_seq = 4
        # self.worker4 = module_worker.Worker(self.th_seq)
    ...
    def rp_dict(self, data):
        ...
        try :
            ...
            # self.func_SET_TableData(1, data['seq'], 0, str(data['item']), 0)
            # self.func_SET_TableData(1, data['seq'], 1, str(data['price']), 0)
            # self.func_SET_TableData(1, data['seq'], 2, str(data['ask_price']), 0)
            # self.func_SET_TableData(1, data['seq'], 3, str(data['bid_price']), 0)
            # self.func_SET_TableData(1, data['seq'], 4, str(data['own_count']), 0)
            # self.func_SET_TableData(1, data['seq'], 5, str(data['unit_price']), 0)
            # if data['percent'] > 0 :
            #     color = 1
            # elif data['percent'] < 0 :
            #     color = 2
            # elif data['percent'] == 0 :
            #     color = 0
            # self.func_SET_TableData(1, data['seq'], 6, str(data['percent']), color)

            # print("status : ", self.status)

        # rp_dict['th_num'] = self.seq
    ...
    def func_SET_tableSUMMARY(self):
        ...
        for i in range(SUMMARY_COL_CNT):
            self.table_summary.setColumnWidth(i, 130)
