...
class Worker(QThread):
    ...
    def dict_from_main(self, data) :
        ...
        item_code = data['item_code']
        # print("worker ", self.seq, item_code)
        ...
        if data['autoTrade'] == 0 :                                             ## manual trading 시
            ...
            if self.first_rcv == 1 :
                ...
                if self.lock == 0 :
                    ...
                    self.judge(item_code, percent, step, own_count, price_buy, t_purchase, t_evaluation)

        ################## judgement ###################
    def judge(self, item_code, percent, step, own_count, price_buy, t_purchase, t_evaluation) :
        # if item_code != "005930" :
