...
# 매수
pyautogui.click(x=1756, y=194)
time.sleep(delay)
pyautogui.typewrite(sys.argv[1])  
time.sleep(delay+1)

pyautogui.click(x=1294, y=458)
time.sleep(delay)

pyautogui.click(x=1356, y=587)
time.sleep(delay)
...
pyautogui.typewrite("3100")  

pyautogui.click(x=1500, y=700)
time.sleep(delay+1)
pyautogui.click(x=1357, y=660)

pyautogui.click(x=1351, y=551)
